      ...
      <div className="grid gap-0 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="border-b border-border/50 p-6 sm:p-8 lg:border-b-0 lg:border-r">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
            <MiniStat icon={Calendar} label="Next halving" value={formatDate(cycle.nextHalving)} />
          ...
          <div className="mt-5 rounded-2xl bg-muted/60 px-4 py-3">
            ...
            <div className="mt-2">
              <Progress value={blockProgress * 100} className="h-1.5" />
            </div>
            ...
            <div className="mt-1 text-[10px] text-muted-foreground/80">
              {formatUtc(cycle.nextHalving)} · last halving block {lastHalvingBlock.toLocaleString()}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col p-6 sm:p-8">
          ...
          {score ? (
            <>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{score.subline}</p>
...
function ComponentMeter({
  ...
  return (
    <div className="rounded-xl border border-border/40 bg-background/60 px-3 py-2.5">
      ...
      {metric && (
        <div className="mt-1 truncate text-[10px] text-muted-foreground/80">{metric}</div>
      )}
    </div>
  );
}
